...
export default function Remembrance() {
  return (
    <div>
      ...
      <br />
      <h3 className="remembrance">Just because we have chizzled abs and stunning features doesn’t mean we too can’t not die in a freak gasoline fight accident.  -Derek Zoolander's eugoogaly</h3>
    </div>
  );
}
